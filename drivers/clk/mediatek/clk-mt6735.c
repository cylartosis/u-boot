...
/*
 * MediaTek clock driver for MT6735 SoC
 *
...
static const struct mtk_composite top_muxes[] = {
	...
	MUX_GATE_FLAGS(CLK_TOP_MUX_MM, mm_parents, 0x40, 24, 3, 31,
		       CLK_DOMAIN_SCPSYS),
	MUX_GATE(CLK_TOP_MUX_PWM, pwm_parents, 0x50, 0, 2, 7),
	MUX_GATE_FLAGS(CLK_TOP_MUX_VDEC, vdec_parents, 0x50, 8, 3, 15,
		       CLK_DOMAIN_SCPSYS),
	MUX_GATE_FLAGS(CLK_TOP_MUX_MFG, mfg_parents, 0x50, 16, 4, 23,
		       CLK_DOMAIN_SCPSYS),
	MUX_GATE_FLAGS(CLK_TOP_MUX_CAMTG, camtg_parents, 0x50, 24, 3, 31,
		       CLK_DOMAIN_SCPSYS),
	...
	MUX_GATE_FLAGS(CLK_TOP_MUX_SCAM, scam_parents, 0x90, 16, 2, 23,
		       CLK_DOMAIN_SCPSYS),
	...
	MUX_GATE_FLAGS(CLK_TOP_MUX_DISPPWM, disppwm_parents, 0xb0, 0, 2, 7,
		       CLK_DOMAIN_SCPSYS)
};
